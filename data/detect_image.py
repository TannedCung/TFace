...
parser.add_argument('-m', '--trained_model', default='/workspace/weights/mobilenet0.25_epoch_1133.pth',
...
if __name__ == '__main__':
    ...
    net = net.to(device)
    images = list(glob.iglob(os.path.join("/workspace/real_test/_3", "*.png")))
    # testing begin
    for i, image_path in enumerate(images):
        # image_path = "./img/samle3.jpg"
        # image_path = "/workspace/Retina/img.jpg"
        ...
        if args.save_image:
            for b in dets:
                ...
                b = list(map(int, b))
                name = f"/workspace/real_test/3/pretty_{i}.jpg"
